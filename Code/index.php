		...
		<nav class="navbar navbar-expand-md navbar-light">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="navbar navbar-nav">
						<li><a class="active onScreen Home" href="#">Home</a></li>
						<li class="dropdown">
...
<!-- Search Button -->
	...
	<main>
	<br />
	<div class="slideshow-container indexDiv">
	...
	<div class="container indexDiv">
			<div class=="row">
				...
				<p>This website is created for telling the users what crop they can grow. The user only needs to specify some details and the
				   ...
				   <br/>
				   The user can either enter the values manually or can use the agriculture robot to get the values for predicting the crop that can be grown.
				   </p>
				<h5>Click on "Crop Prediction" tab above to get started.</h5>
				</div>
				</div>
	</main>
