...
<html lang="en">
<head>
		<title>Entering Values Manually | Crop Prediction</title>
		<meta charset="utf-8">
...
<!-- aria-expanded tells that is dropdown menu is open or not-->
							...
							<ul class="dropdown-menu">
								<li><a href="#">Entering Values Manually</a></li>
...
<!-- Search Button -->
	...
	<main>
		<br/>
		<h2>Entering Values Manually</h2>
				<form action="crop_predicton_results.php" method = "post" class="font-weight-bolder">
...
<!-- Dropdown menu -->
					Soil Type <span class="redStar"> * </span>: <input list="soilType" name="soil" required>
						...
						<br />
					Rainfall(in cm)<span class="redStar"> * </span>: <input type="number" name="rain" placeholder="Rainfall" required step="0.01">
					<br />
					Temperature(in &degC)<span class="redStar"> * </span>: <input type="number" name="temp" placeholder="Temperature" required step="0.01">
					<br />
					pH Value<span class="redStar"> * </span>: <input type="number" name="ph" placeholder="pH" required min="0" max="14" step="0.01">
					<br />
<!-- Checkboxes -->
					Nutrients : <br />
						<label><input type="checkbox" name="nutrients[]" value="N">N</label>
						<label><input type="checkbox" name="nutrients[]" value="P">P</label>
						<label><input type="checkbox" name="nutrients[]" value="K">K</label>
					<br />
